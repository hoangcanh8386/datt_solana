      ...
      const fetchPage = async (page) => {
        const response = await axios.get('https://api.gameshift.dev/nx/items', {
          ...
          params: {
            perPage: 100,
            page: page,
            collectionId: '2600c154-c1ae-458a-a6e2-8083cf9d33ff',
          },
          headers: {
    ...
    <div className="marketplace-container position-relative" style={{
      ...
      <div className="container py-5">
            ...
            <div className="mask" style={{ backgroundColor: 'rgba(0, 0, 0, 0.6)' }}>
              <div className="d-flex justify-content-center align-items-center h-100">
                <div className="text-white">
                  ...
                  <h4 className="mb-3">Đến với thế giới BookNFT</h4>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="text-center mb-5">
          ...
          <p className="lead text-white-50">Khám phá và sở hữu những cuốn sách độc đáo</p>
        </div>
