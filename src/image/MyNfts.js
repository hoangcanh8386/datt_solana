...
const CreateProduct = ({ referenceId, collectionId, onSuccess }) => {
  ...
  const CLOUDINARY_UPLOAD_PRESET = 'HELLO11';
  const CLOUDINARY_CLOUD_NAME = 'djxammjqi';
    ...
    <div>
      ...
      <Modal show={showModal} onHide={handleClose} size="lg">
        <Modal.Header closeButton>
          <Modal.Title className="theme-text">Tạo sách mới</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {error && (
